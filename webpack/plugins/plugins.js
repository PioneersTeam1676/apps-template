...
window.FormValidation = require('@/app/views/plugins/formvalidation/dist/js/FormValidation.full.min.js');
window.FormValidation.plugins.Bootstrap5 = require('@/app/views/plugins/formvalidation/dist/amd/plugins/Bootstrap5.js').default;
...
require('@/app/views/js/vendors/plugins/select2.init.js');

// Flatpickr - is a lightweight and powerful datetime picker.
require('flatpickr/dist/flatpickr.min.js');
require('@/app/views/js/vendors/plugins/flatpickr.init.js');
...
require('@/app/views/js/vendors/plugins/dropzone.init.js');
...
window.toastr = require('@/app/views/plugins/toastr/build/toastr.min.js');
...
require('@/app/views/js/vendors/plugins/sweetalert2.init.js');
